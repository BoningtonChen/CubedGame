...
namespace CubedGame
{
	...
	void ClientLayer::OnUpdate(float ts)
	{
		...
		else if (Walnut::Input::IsKeyDown(Walnut::KeyCode::S)) dir.y = 1;

		if (Walnut::Input::IsKeyDown(Walnut::KeyCode::A)) dir.x = -1;
		else if (Walnut::Input::IsKeyDown(Walnut::KeyCode::D)) dir.x = 1;
